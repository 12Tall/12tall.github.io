...
$$\begin{matrix}df_1 = \frac{\partial f_1}{\partial x_1}dx_{1} + \frac{\partial f_1}{\partial x_2}dx_{2}  \\ df_2 = \frac{\partial f_2}{\partial x_1}dx_{1} + \frac{\partial f_2}{\partial x_2}dx_{2}\end{matrix} \tag{2}$$
...
\end{bmatrix}\begin{bmatrix} dx_1 \\ dx_2 \end{bmatrix} = 
J \begin{bmatrix} dx_1 \\ dx_2 \end{bmatrix} 
$$  
