...
async function main() {
    ...
    cmd.requiredOption("-p, --path <string>", '笔记路径，第一个路径名是大类，如：python/notation')
    ...
    const targetPath = path.resolve(`./docs/${create_time.format("YYYY")}/${post_path}`)
    ...
    console.log(chalk.green.bold(`文件创建成功： ${path.relative(__dirname, targetFile)}`));
